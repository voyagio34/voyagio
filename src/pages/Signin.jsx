...
const SignIn = () => {
  ...
  return (
    <section className="relative min-h-screen px-4 py-16 sm:px-6 lg:px-8 w-full">
      <div className="relative max-w-7xl mx-auto bg-white rounded-2xl shadow-lg sm:px-10 px-6  py-20 w-full text-center">
        {/* Decorative Circles */}
        <div className="absolute sm:block hidden top-20 -left-2 w-46 h-46 bg-gray-100 rounded-full z-0" />
        <div className="absolute top-2 sm:right-4  w-50 h-50 bg-gray-100 rounded-full z-0" />
        <div className="absolute sm:block hidden bottom-20 right-20 w-26 h-26 bg-blue-500/50 rounded-full z-0" />
        <div className="absolute bottom-10 sm:left-10 right-10 w-20 h-20 bg-blue-100 rounded-full z-0" />

        {/* Content */}
        <div className="relative z-10 mb-10 max-w-lg mx-auto">
          <h2 className="sm:text-5xl text-4xl font-medium text-gray-900 mb-1">Welcome back!</h2>
          <p className="text-gray-500 mb-8 text-lg font-light ">Enter your details to sign in</p>

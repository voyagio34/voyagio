        ...
        <div className='bg-gray-50 overflow-x-hidden'>
            ...
            <section className='relative py-20 '>
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col gap-4'>
                    <div className='flex flex-wrap justify-center gap-4 mb-10'>
                        {
                            InfoCards.map((info, index) => {
                                return <div key={index} className='py-8 px-4 items-center gap-2 border-1 max-w-72 w-full shadow-sm bg-gray-50 border-gray-300 rounded-2xl flex flex-col ' data-aos="fade-left" data-aos-delay={ index * 100}>
                    ...
                    <p className='text-lg text-justify font-normal text-gray-500 mb-4' data-aos="fade-left" data-aos-delay="50">Build your perfect trip in just a few steps with Voyagio's intelligent Travel Hub. Whether you're mapping out a weekend getaway or a multi-city journey, our Al- powered system personalizes every detail-so you can stop planning and start experiencing.</p>
                    <p className='text-lg text-justify font-normal text-gray-500 mb-4' data-aos="fade-left" data-aos-delay="50">Everything updates in real time, including weather-based suggestions, schedule changes, and local recommendations. Sync with your mobile app and take your trip wherever you go.</p>

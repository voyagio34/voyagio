                            ...
                            {categories.map((item, index) => {
                                return (
                                    <div
                                        ...
                                        className={`rounded-md transition-all cursor-pointer font-semibold p-4 ${currentCategory == item ? 'bg-blue-500 hover:bg-blue-600 text-white' : 'bg-white text-gray-700 hover:bg-gray-100'}`}
                                    >
                                        <span>{item}</span>
                                    </div>
                                )
